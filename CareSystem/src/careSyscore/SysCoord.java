...
public void load() throws IOException
	...
	DBCollection staffColl = db.getCollection("staffs");
	UserList aUserList = new UserList();
	
	 String title1 = "Ms";
	    String first1 = "Sarah";
	    String surname1 = "Conner";
	    ...
	    Person aServiceUser = new Person();

	    aServiceUser.setName(name1);
	    aServiceUser.setAddress(address1);
	    aServiceUser.setDob(dob1);
	    aServiceUser.setNumber(tel1);
	    aServiceUser.setSex(sex1);
	    
	    aUserList.addServiceUser(aServiceUser);
